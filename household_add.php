...
require_once 'dbconfig.php';
	...
	if($pid=="" || !is_numeric ($pid)) {
		...
		$stmt = $DB_con->prepare('INSERT INTO products(pid,pname,pcost,pqty,poffer,pdept) VALUES(:a, :b, :c, :d, :e, :f)');
			...
			if($stmt->execute())
			{
				...
				header("refresh:1;household_add.php"); 
			}
			else
			{
	...
	if(isset($_POST['clear'])) {
		header("Location: household_add.php"); /* Redirect browser */
		exit();
	}
?>
		...
		<div id="page">
			<div id="header">
				...
				<div id="navigation">
					<ul>
						<li class="selected">
							<a href="household_add.php"> Add </a>
						</li>

						<li>
							<a href="household_view.php">View & delete</a>
						</li>
						...
						<div class="body">
							...
							<form method="post" style="float: left;	color: #5a4535;	height: 300px; width: 400px;border: 1px solid #5a4535;padding: 19px 19px 6px;margin-left: 150px;">
								...
								<table style="border-collapse: collapse;margin-left:60px">
										...
										<tr style="height: 50px;">											
											<td>Department:</td>
											<td><input type="text" value="household" name="pdpt" class="txtfield" ></td>
										</tr>
