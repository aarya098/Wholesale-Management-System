<?php
	...
	if($un=="") {
		...
		$errMSG = "please login as manager ";

	}
	else if($un=="billing" && $pwd=="billing") {
		$errMSG = "please login as manager ";
	}

	else {
		 if($un=="manager" || $pwd=="manager") {
			header("Location: managerchoice.php"); /* Redirect browser */
			exit();
		}
		else {
	...
	<div id="background">
		<div id="page">
			...
			<div id="contents">		
						...
						<div class="body">
							<h1 style="margin-left: 150px">Sign In as manager</h1>
