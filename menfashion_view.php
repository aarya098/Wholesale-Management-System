...
if(isset($_GET['delete_id']))
	{
		...
		header("Location:menfashion_view.php");
	}
?>
			...
			<div id="header">
				...
				<div id="navigation">
					<ul>
						...
						<li class="selected">
							<a href="product_view.php">View & delete</a>
						</li>
				...
				<div class="box">
					<div>
						<div class="body">
							...
							<ul id="rooms">
							<?php
							$stmt = $DB_con->prepare('SELECT * FROM products where pdept="menfashion" ORDER BY pid DESC');
							$stmt->execute();	
							if($stmt->rowCount() > 0) {
